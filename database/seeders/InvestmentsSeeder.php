...
class InvestmentsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $investments = [
            ...
            ['name' => 'Stanchart Frontier ETF', 'type' => 'etf', 'institution' => 'Stanbic', 'purchase_date' => Carbon::now()->subMonths(9)->startOfMonth(), 'quantity' => 3000, 'unit_cost' => 12.0, 'total_cost' => 36000, 'current_price' => 11.20, 'currency' => 'PKR'],
