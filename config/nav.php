        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Credit Notes', 'route' => 'sales.credit_notes.index', 'icon' => 'credit', 'permission' => 'sales.credit_notes.view'],
                 ...
                 ['label' => 'Payment In', 'route' => 'sales.sales_payments.index', 'icon' => 'money', 'permission' => 'sales.sales_payments.view'],
                ...
                ['label' => 'Sales by Salesman', 'route' => 'sales.reports.salesman', 'icon' => 'report', 'permission' => 'sales.reports.view'],
            ],
        ],
        [
            'group' => 'Inventory',
            ...
            'items' => [
                ...
                ['label' => 'Incoming Shipments', 'route' => 'inventory.incoming_shipments.index', 'icon' => 'truck', 'permission' => 'inventory.incoming_shipments.view'],
